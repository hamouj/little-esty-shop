  ...
  describe 'instance_methods' do
    ...
    describe '#merchant_total_discounts()' do
      it 'returns the total discounts applied to invoice items for a specific merchant' do
        merchant1.bulk_discounts.create!(percent_discount: 20, quantity_threshold: 5, name: '20off5')
        ...
        merchant1.bulk_discounts.create!(percent_discount: 30, quantity_threshold: 7, name: '30off7')
        ...
        merchant1.bulk_discounts.create!(percent_discount:15, quantity_threshold: 8, name: '15off8')

        expect(invoice1.merchant_total_discounts(merchant1).round(2)).to eq(total_discount2.round(2))

        # single bulk_discount for merchant 2 (never applied to total_discounts(merchant1))
        merchant2.bulk_discounts.create!(percent_discount:10, quantity_threshold: 3, name: '10off3')
    ...
    describe '#total_discounts' do
      it 'returns the total discount for an invoice' do
        ...
        merchant2.bulk_discounts.create!(percent_discount:20, quantity_threshold: 7, name: '20off7')
